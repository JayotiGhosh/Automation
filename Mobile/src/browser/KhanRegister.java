...
// TODO Auto-generated method stub
		...
		public class KhanRegister {
			...
			//	driver.findElement(MobileBy.AndroidUIAutomator("UiSelector().text(\"OK\")")).click();
				...
				String Msg = driver.findElement(By.className("android.widget.TextView")).getText();
				if (Msg.equals("Passwords should be at least 8 characters long and should contain a mixture of letters, numbers, and other characters.")){
